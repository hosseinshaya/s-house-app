...
class ColorPalette {
  ...
  static ColorPalette dark = ColorPalette(
    ...
    scaffoldBackground: const Color(0xff26282B),
    background: ColorMode(
      main: const Color(0xff353941),
      light: const Color(0xff353941), // todo fix
      dark: const Color(0xff353941),
      background: const Color(0xff353941),
    ),
    selectedBackground: const Color(0xff282B31),
